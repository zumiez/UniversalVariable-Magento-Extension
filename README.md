[![Build Status](https://travis-ci.org/QubitProducts/UniversalVariable-Magento-Extension.png?branch=travis)](https://travis-ci.org/QubitProducts/UniversalVariable-Magento-Extension)
